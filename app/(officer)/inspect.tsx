...
export default function OfficerInspectScreen() {
  ...
  const VendorCard = () => (
    <View style={styles.vendorCard}>
      <View style={styles.vendorCardInner}>
        {vendor.shopPhoto ? (
          <Image source={{ uri: vendor.shopPhoto }} style={styles.vendorThumb} />
        ) : (
  ...
  const FormView = () => (
    <View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.ratingRow}>
          {[1, 2, 3, 4, 5].map((n) => (
            <TouchableOpacity
              key={n}
              style={[styles.ratingBox, cleanliness === n && styles.ratingBoxSelected]}
              onPress={() => setCleanliness(n)}
            >
              <Text style={[styles.ratingNum, cleanliness === n && styles.ratingNumSelected]}>
                {n}
              </Text>
            </TouchableOpacity>
          ))}
      ...
      <View style={styles.section}>
        ...
        <View style={styles.ratingRow}>
          {[1, 2, 3, 4, 5].map((n) => (
            <TouchableOpacity
              key={n}
              style={[styles.ratingBox, orderliness === n && styles.ratingBoxSelected]}
              onPress={() => setOrderliness(n)}
            >
              <Text style={[styles.ratingNum, orderliness === n && styles.ratingNumSelected]}>
                {n}
              </Text>
            </TouchableOpacity>
          ))}
      ...
      <TouchableOpacity style={styles.primaryBtn} onPress={() => setIsReviewing(true)}>
...
const styles = StyleSheet.create({
  ...
  vendorName: { fontSize: 16, fontWeight: "700", color: "#111827", marginBottom: 3 },
  vendorMeta: { flexDirection: "row", alignItems: "center", gap: 3, marginBottom: 2 },
  ...
  // ── Review ──
  reviewTitle: { fontSize: 20, fontWeight: "800", color: "#111827", marginBottom: 16 },
  reviewCard: {
    backgroundColor: "#fff",
    borderRadius: 14,
    padding: 16,
